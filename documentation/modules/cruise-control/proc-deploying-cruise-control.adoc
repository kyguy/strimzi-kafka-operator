...
Deploy Cruise Control through the `cruiseControl` property in the `Kafka` resource.
...
The properties relevant to the Cruise Control deployment are shown in this procedure.

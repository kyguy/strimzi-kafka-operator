...
:cruise-control-project: https://github.com/linkedin/cruise-control[Cruise Control]
:CruiseControlConfig: link:https://github.com/linkedin/cruise-control/wiki/Configurations[Cruise Control documentation]
:JMXExporter: link:https://github.com/prometheus/jmx_exporter[JMX Exporter documentation^]

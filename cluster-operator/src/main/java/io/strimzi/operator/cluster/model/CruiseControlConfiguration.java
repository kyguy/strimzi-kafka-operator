...
public class CruiseControlConfiguration extends AbstractConfiguration {
    ...
    */
    ...
    static {
        ...
        config.put(CruiseControlConfigurationParameters.CRUISE_CONTROL_WEBSERVER_SECURITY_ENABLE.getName(), Boolean.toString(CruiseControl.DEFAULT_WEBSERVER_SECURITY_ENABLED));
        config.put(CruiseControlConfigurationParameters.CRUISE_CONTROL_WEBSERVER_AUTH_CREDENTIALS_FILE.getName(), CruiseControl.getAuthCredentialsFile());
        config.put(CruiseControlConfigurationParameters.CRUISE_CONTROL_WEBSERVER_SSL_ENABLE.getName(), Boolean.toString(CruiseControl.DEFAULT_WEBSERVER_SSL_ENABLED));
